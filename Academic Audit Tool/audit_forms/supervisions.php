...
<head>
    ...
    <script >
        ...
        function add_student(tableID) {
            ...
            element2.type = "text";
            element2.name = 'nature_supervision[]';
            cell2.appendChild(element2);
            ...
            element2.setAttribute("class", "form-control form-control-lg");
            element2.type = "text";
            element2.name = 'awarding_university[]';
            cell2.appendChild(element2);
        ...
        function add_onstudent(tableID) {
            ...
            element2.type = "text";
            element2.name = 'naturesupervision[]';
            cell2.appendChild(element2);
            ...
            element2.setAttribute("class", "form-control form-control-lg");
            element2.type = "text";
            element2.name = 'university_name[]';
            cell2.appendChild(element2);

        }
    </script>
</head>
<body class="body_top"  style="color: #1c7430">
                ...
                <form enctype="multipart/form-data" name="newStaffForm" action="" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="txtComments_no"  name="comp_sup[0]" checked=""
                                   value="NO" onclick="handleClick('NO');">
                            <label class="form-check-label" for="formRadioChecked">NO</label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="comp_sup[0]" id="txtComments_yes"
                                   onclick="handleClick('YES');" value="YES">
                        ...
                        <div class="card-body">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="txtComment_no"
                                       checked="" name="ongoing_sup[0]" value="NO" onclick="handleClick('NO1');">
                                <label class="form-check-label" for="formRadioChecked">NO</label>
                            </div>

                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ongoing_sup[0]" id="txtComment_yes"
                                       value="YES" onclick="handleClick('YES1');">
                                <label class="form-check-label" for="formRadioDefault">YES</label>
                            </div>
                        </div>
